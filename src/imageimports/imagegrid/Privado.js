...
const privadoImages = [
    ...
    {src: privadoImage2, route: "/Proyectos/Privado/ComedorConsum", name: "Comedor Consum"}, 
    {src: privadoImage3, route: "/Proyectos/Privado/EstudioDeArquitectura", name: "Estudio de Arquitectura"}, 
    {src: privadoImage4, route: "/Proyectos/Privado/Joyeria", name: "Joyeria"}, 
]

export default privadoImages;
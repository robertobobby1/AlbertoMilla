...
const publicoImages = [
    ...
    {src: publicoImage2,  route: "/Proyectos/Publico/CentroDeFormacionSilla", name: "Centro de Formacion Silla"},
    {src: publicoImage3,  route: "/Proyectos/Publico/CentroMultifuncional", name: "Centro Multifuncional"},
    {src: publicoImage4,  route: "/Proyectos/Publico/PolideportivoXirivella", name: "Polideportivo Xirivella"},
]

export default publicoImages;
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/Proyectos/Privado/CentroLogisticoConsum",
        element: <CentroLogisticoConsum />,
      },
      { path: "/Proyectos/Privado/ComedorConsum", element: <ComedorConsum /> },
      {
        path: "/Proyectos/Privado/EstudioDeArquitectura",
        element: <EstudioDeArquitectura />,
      },
      { path: "/Proyectos/Privado/Joyeria", element: <Joyeria /> },
      /** Routes for Project galleries (Publico)*/
      {
        path: "/Proyectos/Publico/CasalJoveSilla",
        element: <CasalJoveSilla />,
      },
      {
        path: "/Proyectos/Publico/CentroDeFormacionSilla",
        element: <CentroDeFormacionSilla />,
      },
      {
        path: "/Proyectos/Publico/CentroMultifuncionalCarmenValero",
        element: <CentroMultifuncionalCarmenValero />,
      },
      {
      ...
      {
        path: "/Proyectos/Residencial/CasaAlbereda",
      ...
      { path: "/Proyectos/Residencial/CasaLaBega", element: <CasaLaBega /> },
      {
        ...
        element: <CasaSantaAna />,
      },
      {
        path: "/Proyectos/Residencial/EdificiChaplinSilla",
        element: <EdificiChaplinSilla />,
      },
      { path: "/Proyectos/Residencial/CasaAlcudia", element: <CasaAlcudia /> },
      {
        path: "/Proyectos/Residencial/CasaCentreHistoric",
        element: <CasaCentreHistoric />,
      },
      {
        path: "/Proyectos/Residencial/EdificiLluisVives",
        element: <EdificiLluisVives />,
      },
      {
        path: "/Proyectos/Residencial/EdificiNouAlgemesi",
        element: <EdificiNouAlgemesi />,
      },
      /** Routes for Project galleries (Residencial)*/
      ...
      {
        path: "/Politicas/PoliticaDePrivacidad",
...
function App() {
  return (
    <NavigationBarProvider>
      ...
      <CookieConsent location="bottom" buttonText="Aceptar">
        {" "}
